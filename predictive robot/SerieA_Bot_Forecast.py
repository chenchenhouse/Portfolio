...
class SerieAForecast(object):
    ...
    def found(self):
        ...
        if self.update == False:
            ...
            try:
                url = f'{self.domain_name}/MatchEntryInfo/DateBetween/Serie A/{self.date}~{self.date}'
                ...
                df_group = df.groupby(by=["EventCode","GroupOptionCode","MatchTime"])
                self.update = True
                print("*********************Found SerieA Data successful!!*********************")  
                return df_group
    ...
    def bot_predict(self,df_group):
        ...
        if self.update == True and self.successful == False:
            print("*********************Bot Predict SerieA start*********************")  
            try:
                ...
                print("*********************Bot Predict SerieA successful!!*********************")  
            except Exception as e: 
                print(repr(e))
                print("機器人異常")
