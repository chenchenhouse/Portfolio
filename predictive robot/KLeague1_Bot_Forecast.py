...
class KLeague1Forecast(object):
    ...
    def found(self):
        ...
        if self.update == False:
            print("*********************Found K League 1 Data start*********************")
            try:
                url = f'https://ecocoapidev1.southeastasia.cloudapp.azure.com/MatchEntryInfo/DateBetween/K League 1/{self.date}~{self.date}'
                ...
                df_group = df.groupby(by=["EventCode","GroupOptionCode","MatchTime"])
                self.update = True
                print("*********************Found K League 1 Data successful!!*********************")
                return df_group
    ...
    def bot_predict(self,df_group):
        ...
        if self.update == True and self.successful == False:
            print("*********************Bot Predict K League 1 start*********************")
            try:
                    ...
                    for key,value in df_group:
                        ...
                        if result != True:
                            ...
                            if random_forecast == 0:
                                ...
                                selling_or_forecast = np.random.choice([1, 2], p=[0.8, 0.2])
                                if selling_or_forecast == 2:
                ...
                print("*********************Bot Predict K League 1 successful!!*********************")
            except Exception as e: 
                print(repr(e))
                print("機器人異常")
