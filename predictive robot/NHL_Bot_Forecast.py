...
class NHLForecast(object):
    '''
    預測NHL
    '''
    
    def __init__(self):
        self.account = ["Madeleine","Leonardqq","oo7844512","Reginald7a","Theodoreyyy","qaswwsaq","aa11245778","Bobcat",
                        "Brendan54112","DanDan520"]
    ...
    def found(self):
        ...
        if self.update == False:
            print("*********************Found NHL Data start*********************")   
            try:
                url = f'https://ecocoapidev1.southeastasia.cloudapp.azure.com/MatchEntryInfo/DateBetween/NHL/{self.date}~{self.date}'
                ...
                df_group = df.groupby(by=["EventCode","GroupOptionCode","MatchTime"])
                self.update = True
                print("*********************Found NHL Data successful!!*********************")  
                return df_group
    ...
    def bot_predict(self,df_group):
        ...
        if self.update == True and self.successful == False:
            ...
            try:
                ...
                print("*********************Bot Predict NHL successful!!*********************")  
            except Exception as e: 
                print(repr(e))
                print("機器人異常")
