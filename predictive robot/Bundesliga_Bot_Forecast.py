...
class BundesligaForecast(object):
    '''
    預測Bundesliga
    '''
    ...
    def found(self):
        ...
        if self.update == False:
            ...
            try:
                url = f'{self.domain_name}/MatchEntryInfo/DateBetween/Bundesliga/{self.date}~{self.date}'
                ...
                df_group = df.groupby(by=["EventCode","GroupOptionCode","MatchTime"])
                self.update = True
                print("*********************Found Bundesliga Data successful!!*********************")  
                return df_group
    ...
    def bot_predict(self,df_group):
        ...
        if self.update == True and self.successful == False:
            print("*********************Bot Predict Bundesliga start*********************")  
            try:
                ...
                print("*********************Bot Predict Bundesliga successful!!*********************")  
            except Exception as e: 
                print(repr(e))   
                print("機器人異常")
