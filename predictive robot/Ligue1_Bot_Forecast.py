...
class Ligue1Forecast(object):
    '''
    預測Ligue1
    '''
    
    def __init__(self):
        self.account = ["Bob7777","si845221","Dan0819","Eric4123","Geraldine","Madeleine","Leonardqq","Theodoreyyy","zz123zz55",
                        "Montgomery878","Bobcat","Brendan54112","DanDan520","Mickywin","ss11522148"]
    ...
    def found(self):
        ...
        if self.update == False:
            print("*********************Found Ligue1 Data start*********************")   
            try:
                url = f'https://ecocoapidev1.southeastasia.cloudapp.azure.com/MatchEntryInfo/DateBetween/Ligue 1/{self.date}~{self.date}'
                ...
                df_group = df.groupby(by=["EventCode","GroupOptionCode","MatchTime"])
                self.update = True
                print("*********************Found Ligue1 Data successful!!*********************")  
                return df_group
    ...
    def bot_predict(self,df_group):
        ...
        if self.update == True and self.successful == False:
            print("*********************Bot Predict Ligue1 start*********************")  
            try:
                ...
                print("*********************Bot Predict Ligue1 successful!!*********************")  
            except Exception as e: 
                print(repr(e))
                print("機器人異常")
