...
class WorldChampionshipQual2022Forecast(object):
    '''
    預測WorldChampionshipQual2022
    '''
    
    def __init__(self):
        self.account = ["Geraldine","un77ef8","Reginald7a","Theodoreyyy","zz123zz55","ss11522148","Carlbbomd","ween12235",
    ...
    def found(self):
        '''
        查詢WorldChampionshipQual2022賽事
        '''
        if self.update == False:
            print("*********************Found WorldChampionshipQual2022 Data start*********************")   
            try:
                url = f'https://ecocoapidev1.southeastasia.cloudapp.azure.com/MatchEntryInfo/DateBetween/World Championship Qual 2022/{self.date}~{self.date}'
                ...
                df_group = df.groupby(by=["EventCode","GroupOptionCode","MatchTime"])
                self.update = True
                print("*********************Found WorldChampionshipQual2022 Data successful!!*********************")  
                return df_group
    ...
    def bot_predict(self,df_group):
        '''
        預測WorldChampionshipQual2022賽事
        '''
        if self.update == True:
            print("*********************Bot Predict WorldChampionshipQual2022 start*********************")  
            try:
                ...
                print("*********************Bot Predict SnookerChampionofChampions successful!!*********************")  
            except Exception as e: 
                print(repr(e))
                print("機器人異常")
    ...
    def WorldChampionshipQual2022_predict(self):
        self.delete_log()
